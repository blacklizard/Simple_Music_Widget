...
{
  if (LoadConfigData(GetDir(DIR_ELFS_CONFIG|MEM_EXTERNAL),L"SimpleMusicWidget.bcfg")<0)
  {
    LoadConfigData(GetDir(DIR_ELFS_CONFIG|MEM_INTERNAL),L"SimpleMusicWidget.bcfg");
  }
}
